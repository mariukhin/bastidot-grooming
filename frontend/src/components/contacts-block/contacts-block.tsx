      ...
      <div className={styles.contactsWrapper}>
        ...
        <div className={styles.contactsInfoWrapper}>
          <div className={styles.contactsInfoWrapperCards}>
            <div
              className={classnames(styles.contactsInfoCard, 'reveal')}
              ref={revealRef}
              data-d="1"
            >
            ...
            <div
              className={classnames(
                styles.contactsInfoCard,
                styles.contactsInfoCardHorizontal,
                'reveal'
              )}
              ref={revealRef}
              data-d="4"
          ...
          <div className={classnames(styles.mapBlock, 'reveal')} ref={revealRef}>
            <iframe
              title="Карта: Bastidot Grooming, Велика Васильківська 23А, Київ"

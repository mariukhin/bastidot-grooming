...
const FormExample = () => {
  ...
  return (
    <form
      style={{ width: 400, margin: '0px auto', display: 'flex', flexDirection: 'column', gap: 12 }}
    ...
    >
      ...
      />
      <Button type={'submit'} text={'Primary Red Medium'} />
      ...
      <Button type={'submit'} text={'Secondary Blue Medium'} variant={'secondary'} color={'blue'} />
      <Button
        type={'submit'}
